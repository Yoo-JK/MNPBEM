%% 12_nearfield / rod — MATLAB
%  BEMStat + BEMRet, trirod(10, 40, [15,15,15]) Au
%  31x31 grid: x=-30..30, z=-40..40 at y=0, WL=520nm
...
[x, z] = meshgrid(linspace(-GRID_X, GRID_X, GRID_N), ...
                  linspace(-GRID_Z, GRID_Z, GRID_N));
y = zeros(size(x));

%% Stat
fprintf('[info] BEMStat rod nearfield\n');
p = comparticle(epstab, {trirod(10, 40, [15,15,15])}, [2, 1], 1, op_s);
...
%% Ret
fprintf('[info] BEMRet rod nearfield\n');
p2 = comparticle(epstab, {trirod(10, 40, [15,15,15])}, [2, 1], 1, op_r);
...
fprintf('[info] MATLAB 12_nearfield/rod done.\n');
