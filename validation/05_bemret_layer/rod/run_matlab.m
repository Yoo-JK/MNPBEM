%% 05_bemret_layer / rod — MATLAB
%  trirod(10, 40, [15,15,15]) Au, 1nm above glass, BEMRetLayer + greentab
...
fprintf('[info] BEMRetLayer rod loop\n');
tic;
for i = 1:n
