%% 07_eigenmode / sphere — MATLAB
%  BEMStatEig vs BEMStat, trisphere(144, 20) Au, 400-800nm (41pt)
...
title(sprintf('MATLAB eig/direct sphere (eig=%.3fs, dir=%.3fs)', t_e, t_d));
legend('direct','eig(nev=20)','Location','best'); grid on;
saveas(fig, fullfile(fig_dir,'eigenmode_matlab.png')); close(fig);

fprintf('[info] MATLAB 07_eigenmode/sphere done.\n');
