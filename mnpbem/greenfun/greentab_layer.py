...
class GreenTabLayer(object):
    ...
    def _interp_components(self,
        ...
        # round_z pushes points on the interface outward by zmin so they fall
        # inside the tabulation domain. Critical for near-surface accuracy
        # (demospecret13). Without this, near-layer queries extrapolate.
