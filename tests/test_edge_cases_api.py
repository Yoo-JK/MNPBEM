...
class TestConflictingOptions(object):
    ...
    def test_comparticle_eps_too_short(self):
        ...
        # Either construction fails immediately (preferred) or downstream
        # evaluation must raise — never silently succeed.
        with pytest.raises((IndexError, AttributeError, TypeError, ValueError)):
